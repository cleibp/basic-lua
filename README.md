<h1 align="center"> 🚀 Lua Básico </h1>

## ✍️ Descrição
Exemplificação da sintaxe geral e básica da Linguagem LUA
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/basic-lua.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[REPLIT](https://replit.com/@cleibp/Basic-Lua) 
